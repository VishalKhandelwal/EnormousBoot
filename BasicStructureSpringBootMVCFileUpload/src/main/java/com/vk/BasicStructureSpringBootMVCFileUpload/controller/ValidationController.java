...
import com.vk.BasicStructureSpringBootMVCFileUpload.service.FileManagerService;
...
public class ValidationController {
	...
	public ModelAndView saveSingleFile(@RequestParam MultipartFile file,HttpSession session) throws Exception
	{
	...
	public ModelAndView jQueryValidation(@RequestParam MultipartFile file,HttpSession session) throws Exception
	{
		ServletContext context = session.getServletContext();  
	    String path = context.getRealPath(UPLOAD_DIRECTORY+File.separator+"AllTypeFile");  
	    System.out.println("path");
